...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/SunnyXG/AlertHelper'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SunnyXG' => 'zhangx7635093@163.com' }
  s.source           = { :git => 'https://github.com/SunnyXG/AlertHelper.git', :tag => s.version.to_s }
